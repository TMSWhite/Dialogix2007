...
public class InstrumentSessionDataJPA implements Serializable {
    ...
    public boolean persist() {
        ...
        String query = "INSERT INTO " + tableName + " (StartTime, " + "LastAccessTime, InstrumentStartingGroup, CurrentGroup, LastAction, statusMsg,InstrumentSession_ID, DisplayNum, LanguageCode)" + " VALUES(?,?,?,?,?,?,?,?,?)";
