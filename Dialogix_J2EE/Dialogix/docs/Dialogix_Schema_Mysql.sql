...
--
--                                                                                                                                                                                       
--  CREATE USER 'dialogix_j2ee'@'%' IDENTIFIED BY 'dialogix_j2ee_pass';                                                                                                                  
--                                                                                                                                                                                     
--  GRANT USAGE ON * . * TO 'dialogix_j2ee'@'%' IDENTIFIED BY 'dialogix_j2ee_pass' WITH MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS 0 ;
--                                                                                                                                                                                       
...
CREATE TABLE answer_list_denormalizeds (
  id bigint(20) NOT NULL,
  answer_list_denormalized_len int(11) NOT NULL,
