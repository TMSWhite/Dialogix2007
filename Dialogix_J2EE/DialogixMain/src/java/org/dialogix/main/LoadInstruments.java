/*
 * LoadInstruments.java
 *
 * Created on Apr 21, 2008, 12:47:17 PM
 */
...
import org.dialogix.util.DialogixParserTool;
 ...
 * @author George
 */
public class LoadInstruments extends AbstractRequestBean {
    ...
    public void setLoadTextArea(TextArea ta) {
        this.loadTextArea = ta;
    }
    // </editor-fold>
    ...
    public void init() {
        ...
        try {
            ...
            log("LoadInstruments Initialization Failure", e);
