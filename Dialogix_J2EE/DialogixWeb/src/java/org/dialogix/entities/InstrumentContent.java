...
public class InstrumentContent implements Serializable {
    ...
    @TableGenerator(name = "InstrumentContent_gen", pkColumnValue = "instrument_content", table = "sequence_model", pkColumnName = "seq_name", valueColumnName = "seq_count", allocationSize = 100)
    @Id
