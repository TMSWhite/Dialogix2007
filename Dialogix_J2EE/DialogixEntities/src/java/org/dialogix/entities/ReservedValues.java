...
@Entity
@Table(name = "reserved_values")
public class ReservedValues implements Serializable {
    @TableGenerator(name = "ReservedValues_gen", pkColumnValue = "reserved_values", table = "sequence_model", pkColumnName = "seq_name", valueColumnName = "seq_count", allocationSize = 100)
    @Id
    @GeneratedValue(strategy = GenerationType.TABLE, generator = "ReservedValues_gen")
    @Column(name = "reserved_values_id", nullable = false)
    private Long reservedValuesId;
    ...
    public Long getReservedValuesId() {
        return reservedValuesId;
    }

    public void setReservedValuesId(Long reservedValuesId) {
        this.reservedValuesId = reservedValuesId;
    }
    ...
    public int hashCode() {
        int hash = 0;
        hash += (reservedValuesId != null ? reservedValuesId.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ReservedValues)) {
            return false;
        }
        ReservedValues other = (ReservedValues) object;
        if ((this.reservedValuesId == null && other.reservedValuesId != null) || (this.reservedValuesId != null && !this.reservedValuesId.equals(other.reservedValuesId))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "org.dialogix.entities.ReservedValues[reservedValuesId=" + reservedValuesId + "]";
    }
