...
public class SemanticMappingQA implements Serializable {
    ...
    @TableGenerator(name = "SemanticMappingQA_gen", pkColumnValue = "semantic_mapping_q_a", table = "sequence_map", pkColumnName = "seq_name", valueColumnName = "seq_count", allocationSize = 100)
    @Id
