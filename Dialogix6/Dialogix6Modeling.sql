...
CREATE TABLE Instrument_Content (
	...
	Help_ID int(15) default NULL,	-- only applies to Items
	Readback_ID	int(15)	default NULL,	-- only applies to Items
...
CREATE TABLE Item (
	...
	DataType_ID int(15) NOT NULL,	
	AnswerList_ID	int(15)	default NULL,	-- in case an enumerated list of code set
	Validation_ID int(15) default NULL,
...
--
-- Need a Denormalized AnswerList table in order to test whether full answerList is being re-used, and
-- to ensure can display definition of instrument
--

CREATE TABLE Answer_List_Denormalized (
	AnswerListDenormalized_ID int(15) NOT NULL,
	AnswerList_ID int(15) NOT NULL,
	AnswerListDenormalizedString text NOT NULL, -- delimited list of answer options and messages
  LanguageCode char(5) NOT NULL default 'en',
  
 	KEY k1_AnswerListDenormalized (LanguageCode),
	KEY k2_AnswerListDenormalized (AnswerListDenormalizedString(400)),
	PRIMARY KEY pk_AnswerListDenormalized (AnswerListDenormalized_ID)
) ENGINE=InnoDB;	
...
ALTER TABLE Instrument_Content
  ...
  ADD CONSTRAINT InstrumentContent_ibfk_6 FOREIGN KEY (Readback_ID) REFERENCES Readback (Readback_ID);
...
ALTER TABLE Answer_List_Denormalized
  ADD CONSTRAINT AnswerListDenormalized_ibfk_1 FOREIGN KEY (AnswerList_ID) REFERENCES Answer_List(AnswerList_ID);
...
(1, 'tmw', 'eb096028a05cab1f73859ac90754c407', '*687D777FB6B074B76F3A0F30B4A5E458F68653D4', 1194406253),
(2, 'george', 'b638b18a98fbad4af7b9020e88a1f326', '*200723CFEFA28BE138907A1D3119D0051D3E5A1D', 1193853271);
...
--
--  Below is a Version1 modeling of Dialogix which replaces the Perl Functions (ignoring PageHits and Events)
--
...
CREATE TABLE V1_Data_Element (
  ...
  responseDuration int(11) default NULL,
	...
	KEY k1_V1DataElement (LanguageCode),
	KEY k2_V1DataElement (VarName),
