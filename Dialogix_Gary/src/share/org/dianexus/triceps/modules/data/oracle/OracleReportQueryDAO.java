...
public class OracleReportQueryDAO implements ReportQueryDAO {
	...
	private static final String ORACLE_GET_REPORT_QUERY ="SELECT * FROM report_query WHERE id = ?";
	private static final String ORACLE_SET_REPORT_QUERY ="INSERT INTO report_query SET user_id = ?,instrument_version_id = ?, ts = ?, query_string =?";
	private static final String ORACLE_DELETE_REPORT_QUERY="DELETE FROM report_query WHERE id = ?";
	private static final String ORACLE_UPDATE_REPORT_QUERY="UPDATE report_query SET user_id = ?,instrument_version_id = ?, ts = ?, query_string =?  WHERE id =?";
	...
	public boolean setReportQueryDAO() {
		...
		boolean rtn = false;
		try {
			ps = con.prepareStatement(ORACLE_SET_REPORT_QUERY);
			ps.clearParameters();
	...
	public boolean getReportQueryDAO(int id) {
		...
		boolean rtn = false;
		try {
			ps = con.prepareStatement(ORACLE_GET_REPORT_QUERY);
			ps.clearParameters();
	...
	public boolean updateReportQueryDAO() {
		...
		boolean rtn = false;
		try {
			ps = con.prepareStatement(ORACLE_UPDATE_REPORT_QUERY);
			ps.clearParameters();
	...
	public boolean deleteReportQueryDAO(int id) {
		...
		boolean rtn = false;
		try {
			ps = con.prepareStatement(ORACLE_DELETE_REPORT_QUERY);
			ps.clearParameters();
