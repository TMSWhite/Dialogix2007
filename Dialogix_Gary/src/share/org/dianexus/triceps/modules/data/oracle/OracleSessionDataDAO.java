 ...
 * 
 */
public class OracleSessionDataDAO implements SessionDataDAO {
	// sql
	public static final String ORACLE_SESSION_DAO_GET_LAST_INSERT_ID = "SELECT LAST_INSERT_ID()";
	...
	public boolean setSessionData(String tableName) {
		...
		try {
			...
			stmt = con.prepareStatement(ORACLE_SESSION_DAO_GET_LAST_INSERT_ID);
	...
	public boolean setStartingValues(String defaultText, String tableName,
		...
		// write the data
		Connection con3 = DialogixOracleDAOFactory.createConnection();
		Statement stmt = null;
		try {
	...
	public boolean setSessionValue(String col, String data) {
		Connection con4 = DialogixOracleDAOFactory.createConnection();
		PreparedStatement stmt = null;
		try {
