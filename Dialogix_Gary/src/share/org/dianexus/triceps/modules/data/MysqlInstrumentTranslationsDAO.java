...
public class MysqlInstrumentTranslationsDAO implements InstrumentTranslationsDAO {
  static Logger logger = Logger.getLogger(MysqlInstrumentTranslationsDAO.class);
	...
	private static final String SQL_INSTRUMENT_TRANSLATIONS_DELETE = "DELETE FROM InstrumentTranslations where ID = ?";
	...
	public int getInstrumentTranslationsId() {
		return getInstrumentTranslationsId();
	}

	public int getInstrumentTranslationsLastInsertId() {
		return getInstrumentTranslationsLastInsertId();
	}
