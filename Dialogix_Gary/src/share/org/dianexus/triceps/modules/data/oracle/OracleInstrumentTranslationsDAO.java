...
public class OracleInstrumentTranslationsDAO implements InstrumentTranslationsDAO {
	...
	private static final String ORACLE_INSTRUMENT_TRANSLATIONS_INSERT = "INSERT INTO InstrumentTranslations VALUES(null,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
	private static final String ORACLE_INSTRUMENT_TRANSLATIONS_DELETE = "DELETE FROM InstrumentTranslations where ID = ?";
	private static final String ORACLE_INSTRUMENT_TRANSLATIONS_UPDATE = "UPDATE InstrumentTranslations SET InstrumentName=?,LanguageNum=?," +
	...
	private static final String ORACLE_INSTRUMENT_TRANSLATIONS_GET = "SELECT * FROM InstrumentTranslations WHERE ID = ?";
	private static final String ORACLE_INSTRUMENT_TRANSLATIONS_NAME_GET = "SELECT * FROM InstrumentTranslations WHERE InstrumentName = ?";
	public boolean deleteInstrumentTranslations(int _id) {
		Connection con = DialogixOracleDAOFactory.createConnection();
		PreparedStatement ps = null;
		ResultSet rs = null;
		try {
			ps = con.prepareStatement(ORACLE_INSTRUMENT_TRANSLATIONS_DELETE);
			ps.clearParameters();
	...
	public boolean getInstrumentTranslations(int _id) {
		...
		boolean ret = false;
		try {
			ps = con.prepareStatement(ORACLE_INSTRUMENT_TRANSLATIONS_GET);
			ps.clearParameters();
			ps.setInt(1, _id);
	...
	public boolean getInstrumentTranslations(String _name) {
		...
		boolean ret = false;
		try {
			ps = con.prepareStatement(ORACLE_INSTRUMENT_TRANSLATIONS_NAME_GET);
			ps.clearParameters();
	...
	public boolean setInstrumentTranslations() {
		...
		boolean ret = false;
		try {
			ps = con.prepareStatement(ORACLE_INSTRUMENT_TRANSLATIONS_INSERT);
			ps.clearParameters();
	...
	public boolean updateInstrumentTranslations(String _column, String value) {
		...
		boolean ret = false;
		try {
			ps = con.prepareStatement(ORACLE_INSTRUMENT_TRANSLATIONS_UPDATE);
			ps.clearParameters();
